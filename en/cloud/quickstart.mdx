...
<Info>
**Live today:** build against the global **test** cluster — API `https://test-mirobody-api.thetahealth.ai/v1`, console [test-platform.mirobody.ai](https://test-platform.mirobody.ai/). Production and the China cluster are provisioning ([Regions](/en/cloud/regions/overview)). The console defaults to Chinese — use the language switch (top-right) for English.
</Info>
