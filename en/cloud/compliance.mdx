...
<AccordionGroup>
  ...
  <Accordion title="User rights" icon="key">
    Per-Subject data export via the API ([structured data](/en/api-reference/data) / [files](/en/api-reference/files)); ending a session purges its data ([sessions](/en/api-reference/sessions)). For account deletion or a full data-erasure request, contact [Mirobody Support](mailto:developer@thetahealth.ai).
  </Accordion>
</AccordionGroup>
