...
| **API — test cluster** | `https://test-mcp.thetahealth.cn/v1` |
...
The **test cluster** is for integration testing only — its data is non-production and may be reset at any time. Point at the prod `base_url` for real workloads.
