...
<AccordionGroup>
  <Accordion title="Track health issues across systems and years" icon="timeline">
    ...
    <CardGroup cols={2}>
      <Card title="Knee Pain Progress" icon="link" href="https://chat.mirobody.ai/">
        Track knee pain progression across providers
      </Card>
      <Card title="Cardiovascular Disorders" icon="link" href="https://chat.mirobody.ai/">
  ...
  <Accordion title="Unified health issue analysis" icon="chart-line">
    ...
    <CardGroup cols={2}>
      <Card title="Cardiovascular Summary" icon="link" href="https://chat.mirobody.ai/">
        Summarize cardiovascular conditions across sources
      </Card>
      <Card title="Diabetes History & Progress" icon="link" href="https://chat.mirobody.ai/">
  ...
  <Accordion title="Prepare for doctor visits" icon="user-doctor">
    <Card title="PCP Visit Preparation" icon="link" href="https://chat.mirobody.ai/">
...
<AccordionGroup>
  <Accordion title="Identify patterns and drivers" icon="magnifying-glass-chart">
    ...
    <CardGroup cols={2}>
      <Card title="Blood Glucose Analysis" icon="link" href="https://chat.mirobody.ai/">
        Find factors that help or harm your blood glucose
      </Card>
      <Card title="Symptoms & Feelings Drivers" icon="link" href="https://chat.mirobody.ai/">
  ...
  <Accordion title="Personalized treatment research" icon="flask">
    <Card title="Diabetes Treatment Options" icon="link" href="https://chat.mirobody.ai/">
...
[**Theta Wellness**](https://www.thetahealth.ai/) is our flagship consumer application built on Mirobody — a personal health intelligence app that demonstrates what Mirobody can do at production scale. It connects wearables, phone health stores, and EHR records, and supports voice, image, file, and text as inputs.

[**platform.mirobody.ai**](https://platform.mirobody.ai/) is the hosted developer console for the API below — API keys, usage, and a live Playground for the ingest → standardize → agent flow. Prefer to try Mirobody directly first, without integrating anything? [**chat.mirobody.ai**](https://chat.mirobody.ai/) is Mirobody's own free, web-only client — standardize your data and see the engine at work, including side-by-side comparison across AI models.
