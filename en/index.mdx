...
<CardGroup cols={2}>
  ...
  <Card
    ...
    icon="plug"
    href="/development/provider-integration"
    >
...
<Steps>
  <Step title="Get Started">
    Follow our [Quick Start guide](/quickstart) to deploy Mirobody Health locally in minutes using Docker.
  </Step>
  
  <Step title="Configure Providers">
    Set up OAuth credentials for the health providers you want to integrate. See the [Configuration guide](/configuration).
  </Step>
  
  <Step title="Explore the API">
    Review the [API Reference](/api-reference/introduction) to understand how to link users, pull data, and access health information.
  </Step>
  
  <Step title="Add Custom Providers">
    Follow the [Provider Integration Guide](/providers/integration-guide) to add support for additional health devices.
  </Step>
</Steps>
