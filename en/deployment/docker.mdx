...
description: "Deploy Mirobody using Docker and Docker Compose"
---

## Overview

Docker provides the easiest way to deploy Mirobody with all its dependencies in isolated containers.
...
For production deployment, see [Production Deployment](/en/deployment/production).
