...
description: "Complete guide to integrating new health device APIs into Mirobody"
---
...
<Info>
If you're looking to **use** existing providers like Garmin or Whoop, see [Using Providers](/en/providers/using-providers) instead.
</Info>
...
└── platform/
    ...
    ├── pull_task.py         # Scheduled data pulls
...
Review these provider implementations for reference:
- **Garmin Connect**: `mirobody/pulse/theta/mirobody_garmin_connect/`
- **Whoop**: `mirobody/pulse/theta/mirobody_whoop/`

For complete implementation details, see the <a href="https://github.com/thetahealth/mirobody/blob/main/mirobody/pulse/README.md">Provider Integration Guide</a> in the repository.
...
<Steps>
  ...
  <Step title="Configure OAuth">
    Add configuration to your config file (e.g., `config.localdb.yaml`):
...
<AccordionGroup>
  ...
  <Accordion title="OAuth Implementation" icon="key">
    ...
    **OAuth 2.0** (e.g., Whoop):
    ...
    See [OAuth Implementation](/en/development/oauth-implementation) for detailed examples.
  </Accordion>
  ...
  <Accordion title="Data Mapping" icon="arrows-rotate">
    ...
    See [Data Mapping](/en/development/data-mapping) for transformation patterns.
  </Accordion>
  ...
  <Accordion title="Testing" icon="flask">
    ...
    See [Provider Testing](/en/development/provider-testing) for guidelines.
  </Accordion>
</AccordionGroup>
...
<Frame>
  <img src="/images/provider-link-flow.svg" alt="Provider link and scheduled-sync flow" />
</Frame>
...
<Tip>
See [Garmin Provider Example](/en/examples/garmin-provider) and [Whoop Provider Example](/en/examples/whoop-provider) for complete implementations.
</Tip>
...
<CardGroup cols={2}>
  ...
  <Card title="Full Integration Guide" icon="book" href="https://github.com/thetahealth/mirobody/blob/main/connect/PROVIDER_INTEGRATION_GUIDE.md">
...
See [Standard Indicators](/en/providers/overview#standard-health-indicators) for the complete list.
...
<Steps>
  ...
  <Step title="Submit pull request">
    Follow the [Contributing Guide](/en/development/contributing)
  </Step>
</Steps>

<Note>
See the <a href="https://github.com/thetahealth/mirobody/blob/main/connect/PROVIDER_INTEGRATION_GUIDE.md">complete Provider Integration Guide</a> in the repository for detailed implementation instructions, including all required methods, OAuth patterns, data transformation examples, and best practices.
</Note>
