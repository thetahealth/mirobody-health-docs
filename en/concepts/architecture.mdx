...
<Frame caption="Mirobody architecture: Clients → AI & Agent Engine → FHIR & Health Standards → Health Data Pipeline (Pulse) → Infrastructure">
  <img src="/images/architecture.jpeg" alt="Mirobody architecture overview" />
</Frame>
