...
<Frame>
  <img src="/images/provider-lifecycle.svg" alt="Provider lifecycle: Discovered → Validated → Registered → Active → Linked → Syncing, with continuous sync and unlink/re-link" />
</Frame>
