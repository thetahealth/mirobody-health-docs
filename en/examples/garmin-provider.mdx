...
<Info>
This is a `vendor::Vendor`, not a Python `BaseThetaProvider`. It implements the shared `authorize / fetch / webhook` contract; see [Vendor System](/en/concepts/providers) for the interface.
</Info>
