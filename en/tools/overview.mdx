...
| Feature | DeepAgent | MixAgent | BaselineAgent |
|---------|-----------|----------|---------------|
...
- Short Q&A — the two-pass overhead isn't worth it; use DeepAgent or BaselineAgent.
...
<Steps>
  ...
  <Step title="Use in agents">
    Both DeepAgent and MixAgent (orchestrator phase) can use your custom tools automatically. BaselineAgent runs without tools by design.
  </Step>
</Steps>
