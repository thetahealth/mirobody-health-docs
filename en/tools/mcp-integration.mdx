...
Mirobody functions as an **OAuth-enabled MCP Server** that exposes all your tools to AI clients like Claude Desktop, Cursor, and custom MCP clients.
...
Mirobody can also function as a GPT app, enabling capabilities within ChatGPT. Read more at [ChatGPT Apps](/en/tools/chatgpt-apps).
