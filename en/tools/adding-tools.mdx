...
description: "Learn how to create custom tools for AI agents in Mirobody"
---

## Overview

Adding custom tools to Mirobody is incredibly simple. Write Python functions, and they automatically become available to AI agents through the MCP protocol.
