...
description: "Default health tools provided by Mirobody"
---

## Overview

Mirobody includes two essential health tools that enable AI agents to access and analyze user health data securely.
...
<ParamField body="indicator" type="string" required>
  ...
  See [Standard Indicators](/en/providers/overview#standard-health-indicators) for complete list.
</ParamField>
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="book" href="/en/api-reference/mcp-servers">
