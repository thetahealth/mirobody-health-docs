...
description: "Overview of the Mirobody API"
---

## Welcome to the API

The Mirobody API provides programmatic access to health device integrations, data retrieval, and AI-powered health insights.
...
Mirobody supports webhooks for real-time health data updates from providers:
