...
The Model Context Protocol (MCP) is a JSON-RPC 2.0 interface that enables AI agents and applications to discover and interact with Mirobody's tools and resources. It provides a standardized way for LLMs to access health data, call functions, and retrieve contextual information.
...
Mirobody MCP tools are organized into categories:
