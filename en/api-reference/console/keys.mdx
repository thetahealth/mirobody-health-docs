...
<Note>
Most teams just use the console UI: [platform.mirobody.ai](https://platform.mirobody.ai/developer/keys) → **API Keys**. The REST endpoints below are for automation.
</Note>
