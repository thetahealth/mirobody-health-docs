...
The China cluster keeps 100% of data within mainland China. It's mid-migration to the new `mirobody-api.thetahealth.cn` host and is currently **provisioning** — for live integration today, use the [global test cluster](/en/api-reference/regions/global).
