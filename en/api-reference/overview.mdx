...
You create keys, watch usage, and try an interactive Playground in the [developer console](https://cdm.thetahealth.cn/). These docs are the API reference.
...
Authenticate every call with an `mb_live_*` key — see [Authentication](#authentication). A global region is **coming soon**; see [Regions](/en/cloud/regions/overview).
