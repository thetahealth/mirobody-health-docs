...
Two clusters, one contract: the global API (`https://api.mirobody.ai/v1`) and the **China** API (`https://api.mirobody.cn/v1`). See [Regions](/en/api-reference/regions/overview).
