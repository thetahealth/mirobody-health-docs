...
description: "wss /ws/upload-health-report — large file upload with real-time progress; requires BYOK"
---

<Warning>
**This endpoint requires LLM credentials.** Because WebSocket cannot set HTTP headers, pass them as query params: `?llm_provider=...&llm_api_key=...`. See [BYOK](/en/cloud/byok/index).
</Warning>
