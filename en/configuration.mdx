...
- **GOOGLE_API_KEY**: Required for processing files (PDFs, images, medical records) using Google Gemini
</Info>
...
<Steps>
  ...
  <Step title="Get Google API Key (Gemini)">
    1. Visit [Google AI Studio](https://aistudio.google.com/)
    2. Sign in with your Google account
    3. Click "Get API key" and create a new key
    
    <Info>
    Google Gemini is required for file processing capabilities (PDFs, images, medical records).
    </Info>
  </Step>
</Steps>
...
<Warning>
Google API Key (Gemini) is **required** for processing multimodal files including PDFs, images (PNG, JPEG, HEIC), and audio files. Without this key, file upload and processing features will not work.
</Warning>
