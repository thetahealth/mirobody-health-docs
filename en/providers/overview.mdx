...
description: "Understanding the provider system in Mirobody and how it integrates with health device APIs"
---

## What are Providers?

Providers are plugin modules that integrate Mirobody with external health and fitness device APIs. Each provider handles OAuth authentication, data fetching, and transformation into a standardized format.

## Provider Architecture

Mirobody uses an extensible provider architecture that makes it easy to add new health device integrations:
...
<Tabs>
  ...
  <Tab title="Configuration">
    ...
    See [Configuration Guide](/en/configuration) for detailed setup instructions.
  </Tab>
</Tabs>
...
Mirobody automatically discovers and loads providers from configured directories:

```python
# In config.yaml
THETA_PROVIDER_DIRS:
  - mirobody/pulse/theta     # Theta providers
  - mirobody/pulse/custom    # Your custom providers
```
