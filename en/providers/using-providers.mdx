...
<Note>
More providers are coming soon. You can also [add custom providers](/development/provider-integration) yourself!
</Note>
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="book" href="/api-reference/pulse/providers">
    Provider API documentation
  </Card>
  <Card title="Provider Examples" icon="code" href="/examples/garmin-provider">
    See provider usage examples
  </Card>
  <Card title="Add Custom Providers" icon="plus" href="/development/provider-integration">
