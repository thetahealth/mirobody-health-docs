---
title: "Garmin Provider Example"
description: "Complete implementation example of the Garmin Connect provider"
---
...
<CardGroup cols={2}>
  <Card title="Whoop Example" icon="code" href="/examples/whoop-provider">
