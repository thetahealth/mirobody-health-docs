---
title: "构建自定义提供商"
description: "将新的健康设备 API 集成到 Mirobody 的完整指南"
---
...
如需完整的实现细节，请参阅仓库中的 <a href="https://github.com/thetahealth/mirobody/blob/main/mirobody/pulse/README.md">提供商集成指南</a>。
...
<CardGroup cols={2}>
  ...
  <Card title="完整集成指南" icon="book" href="https://github.com/thetahealth/mirobody/blob/main/connect/PROVIDER_INTEGRATION_GUIDE.md">
    项目仓库中的完整指南
  </Card>
</CardGroup>
...
<Note>
有关详细的实现说明，包括所有必需的方法、OAuth 模式、数据转换示例和最佳实践，请参阅仓库中完整的<a href="https://github.com/thetahealth/mirobody/blob/main/connect/PROVIDER_INTEGRATION_GUIDE.md">提供商集成指南</a>。
</Note>
