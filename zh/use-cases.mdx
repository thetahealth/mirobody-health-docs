...
<AccordionGroup>
  <Accordion title="跨系统、跨年份追踪同一健康问题" icon="timeline">
    ...
    背后 Agent 会取用户的[健康画像](/zh/api-reference/chat/history)、搜索与关节相关的指标历史、调出事件 / 日记 / 用药记录，最后把机械负荷代理指标（步数、步行配速）和疼痛事件按时间叠加成图。

    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/99f93ed9-66d7-48c0-a393-fcbb9edfcad0">
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/20312385-ef49-4808-8293-d4b6a34d1a35">
      跨医疗系统监测心血管健康。
    </Card>
  ...
  <Accordion title="跨数据源统一分析" icon="chart-line">
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/e3cce3ee-61fe-40f5-ab6e-8d3044041624">
      跨数据源汇总心血管状况。
    </Card>
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/ceb03bce-c467-4524-95fe-21be7711c275">
      从设备、病历、其他来源追踪糖尿病。
    </Card>
  ...
  <Accordion title="就诊准备 —— 带一份真正能用的文档进诊室" icon="user-doctor">
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/1bc10225-b454-48f3-8f82-3a1b4bbb07b3">
      给关联亲属准备就诊文档 + 待问问题清单。
    </Card>
...
<AccordionGroup>
  <Accordion title="识别哪些事在帮你、哪些在拖你" icon="magnifying-glass-chart">
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/365bd176-6fc2-42f3-9ed1-2dda3c1995c5">
      定位影响血糖的因子（有利 vs 有害）。
    </Card>
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/3d26aa74-bebf-44b9-aae9-258501098dae">
      发现症状与情绪背后的主导原因。
    </Card>
  ...
  <Accordion title="个性化治疗方案研究" icon="flask">
    ...
    <Card title="打开对话" icon="link" href="https://mirobody.thetahealth.cn/share/767acf0d-4771-4887-9722-285dbc3c853e">
      个性化糖尿病治疗方案研究。
    </Card>
