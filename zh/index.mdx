...
<AccordionGroup>
  ...
  <Accordion title="三种 Agent 各司其职" icon="robot">
    ...
    - **BaseAgent** —— 不调工具、直连 LLM，适合低延迟 Q&A
  </Accordion>
...
| 模块 | 路径 | 说明 |
|------|------|------|
| **Agent 运行时** | `mirobody/pub/agents/` | DeepAgent、MixAgent、BaseAgent |
...
<AccordionGroup>
  <Accordion title="跨系统、跨年度追踪同一健康问题" icon="timeline">
    ...
    <CardGroup cols={2}>
      ...
      <Card title="心血管历史" icon="link" href="https://mirobody.thetahealth.cn/share/f1ed967e-db4c-457c-bbc5-106352e5af8c">
        跨医疗系统监测心血管健康
      </Card>
    </CardGroup>
  </Accordion>
...
<Steps>
  ...
  <Step title="探索 API">
    阅读 [API 参考](/zh/api-reference/overview) 了解 Pulse、Chat 和 MCP 端点。
  </Step>
