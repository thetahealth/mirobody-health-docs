---
title: "内置 Tools"
description: "Mirobody 默认提供的健康 tools"
---

## 概览

Mirobody 默认包含两个关键的健康 tools，使 AI agents 能够安全访问并分析用户 health 数据。
...
<CardGroup cols={2}>
  ...
  <Card title="API Reference" icon="book" href="/zh/api-reference/mcp-servers">
    MCP 协议的 tools 文档
  </Card>
</CardGroup>
