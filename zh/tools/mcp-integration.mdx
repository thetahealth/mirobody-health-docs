...
description: "将 Mirobody 的 Tools 连接到 Claude、Cursor、ChatGPT 等 MCP clients"
---

## 概览

Mirobody 可作为 **支持 OAuth 的 MCP Server**，把你的所有 Tools 暴露给 Claude Desktop、Cursor 以及自定义 MCP clients 等 AI 客户端。
...
<Check>
你应该能在 AI 客户端中看到可用的 Mirobody Tools！
</Check>
...
<Note>
OAuth token 由 Mirobody 管理。用户只需认证一次，Tools 即可安全访问其数据。
</Note>
