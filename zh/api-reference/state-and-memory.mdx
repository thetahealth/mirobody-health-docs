...
- **三个删除层级**：`DELETE /v1/responses/{id}` 移除单条记录**并回撤其对话沉淀的记忆**；[`DELETE /v1/sessions/{id}`](/zh/api-reference/sessions) 拆除整个日记会话；[`DELETE /v1/subjects/{user}`](/zh/api-reference/subjects) 擦除该 Subject 的一切。
