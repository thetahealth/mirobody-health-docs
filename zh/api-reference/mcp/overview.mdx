...
Model Context Protocol (MCP) 是一个 JSON-RPC 2.0 接口，使 AI agent 和应用程序能够发现 Mirobody 的工具（tools）和资源（resources）并与之交互。它为 LLM 访问健康数据、调用函数和检索上下文信息提供了一种标准化方式。
