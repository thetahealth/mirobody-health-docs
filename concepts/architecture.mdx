...
<AccordionGroup>
  <Accordion title="New Providers" icon="plus">
    See [Development](/development/setup) new health device integrations:
  </Accordion>

  <Accordion title="Tools & MCPs" icon="wrench">
    1. See [Adding Custom Tools](/tools/adding-tools) to add new tools for AI agents
    2. See [Adding Custom MCPs](/tools/adding-mcps) to add new MCPs for AI agents
  </Accordion>
...
<CardGroup cols={2}>
  <Card title="Provider System" icon="plug" href="/concepts/providers">
    Deep dive into the provider system
  </Card>
  <Card title="Data Flow" icon="arrow-progress" href="/concepts/data-flow">
